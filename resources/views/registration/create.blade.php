...
<head>
    ...
    <title>Formulir Pendaftaran Anggota KOSUDGAMA</title>
    ...
    <style>
        ...
        .form-container::before {
            content: "";
            background-image: url('https://i.ibb.co/L89G0zK/logo-kosudgama-watermark.png');
            background-repeat: no-repeat; background-position: center; background-size: contain;
            position: absolute; top: 50%; left: 50%;
            transform: translate(-50%, -50%);
            width: 50%; height: 50%; opacity: 0.1; z-index: 0;
        }
        ...
        .form-input, .form-textarea {
            font-size: 12px; width: 100%; padding: 2px 6px; height: 24px;
        ...
        /* Style untuk kotak-kotak input */
        .char-box-container { display: flex; gap: 2px; }
        .char-box {
            width: 22px; height: 24px; text-align: center; padding: 0;
...
<body>
    <div class="container mx-auto max-w-4xl p-4 sm:p-8 my-10">
        <div class="form-container bg-white shadow-lg p-4 sm:p-6">
            <div class="form-content">
                <!-- HEADER -->
                <header class="flex items-center justify-between border-b-4 border-black pb-2 mb-2">
                    <div>
                        <h1 class="header-title text-4xl -mb-2">FORMULIR</h1>
                        <p class="font-bold text-lg">Aplikasi Keanggotaan</p>
                    </div>
                    <div class="text-right">
                        <div class="flex justify-end items-center gap-2">
                            <div>
                                <h2 class="header-title text-md">KOPERASI KONSUMEN</h2>
                                <h2 class="header-title text-md">KOSUDGAMA DAYA GEMILANG</h2>
                                <p class="text-xs font-bold">YOGYAKARTA</p>
                            </div>
                ...
                @if ($errors->any())
                    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-2 rounded relative my-3 text-sm" role="alert">
                ...
                <form action="{{ route('registration.store') }}" method="POST" enctype="multipart/form-data" id="registrationForm" class="mt-3 space-y-3">
                    ...
                    <div class="border-2 border-black">
                        ...
                        <div class="p-3 space-y-2">
                            <div class="input-group">
                                <label for="nama_lengkap" class="form-label w-1/3">Nama (20 digit dalam kartu anggota)</label>
                            ...
                            <div class="flex items-center gap-6">
                                <div class="input-group w-2/3">
                                    ...
                                    <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-input" required value="{{ old('tempat_lahir') }}">
                            ...
                            <div class="input-group">
                                <label class="form-label">Mengenal KOSUDGAMA dari</label>
                             ...
                             <div class="pt-1">
                                <label class="form-label">Fasilitas yang menarik di KOSUDGAMA (boleh diisi lebih dari satu)</label>
                                <div class="grid grid-cols-5 gap-x-4 gap-y-1 mt-1">
                    ...
                    <div class="border-2 border-black">
                        ...
                        <div class="p-3 space-y-2">
                            ...
                            <div class="input-group">
                                <label for="no_hp_boxes" class="form-label w-32">Hand Phone</label>
                                <div id="no_hp_boxes" class="char-box-container">
                                    @for ($i = 0; $i < 13; $i++)
                                    <input type="text" maxlength="1" class="char-box">
                                    @endfor
                                </div>
                            ...
                            <div class="input-group">
                                <label class="form-label w-32">Kartu Identitas</label>
                                <label for="no_ktp_boxes" class="form-label">KTP No.</label>
                                <div id="no_ktp_boxes" class="char-box-container">
                                    @for ($i = 0; $i < 16; $i++)
                                    <input type="text" maxlength="1" class="char-box">
                                    @endfor
                                </div>
                             ...
                             <div class="input-group">
                                <label for="email" class="form-label w-32">E-Mail</label>
                    ...
                    <div class="border-2 border-black">
                        ...
                        <div class="p-3 space-y-2">
                            <div class="input-group">
                                <label class="form-label w-32">Pekerjaan <span class="font-normal text-gray-500 text-xs">(*Coret salah satu)</span></label>
                                <div class="grid grid-cols-3 gap-x-4 gap-y-1 w-full">
                            ...
                            <div class="input-group">
                                <label for="nama_instansi" class="form-label w-32">Nama Kantor/Instansi</label>
                                <input type="text" id="nama_instansi" name="nama_instansi" class="form-input" required value="{{ old('nama_instansi') }}">
                            </div>
                            <div class="input-group">
                                <label for="alamat_instansi" class="form-label w-32">Alamat Kantor</label>
                                <input type="text" id="alamat_instansi" name="alamat_instansi" class="form-input" required value="{{ old('alamat_instansi') }}">
                            </div>
                             <div class="grid grid-cols-2 gap-x-8">
                                <div class="input-group">
                                    <label for="telp_instansi" class="form-label w-32">Telepon</label>
                                    <input type="text" id="telp_instansi" name="telp_instansi" class="form-input" required value="{{ old('telp_instansi') }}">
                                </div>
                                <div class="input-group">
                                    <label for="kode_pos_instansi" class="form-label">Kode Pos</label>
                                    <input type="text" id="kode_pos_instansi" name="kode_pos_instansi" class="form-input w-24" required value="{{ old('kode_pos_instansi') }}">
                                </div>
                             </div>
                        </div>
                    </div>
                    
                    <!-- REFERENSI ANGGOTA & PERNYATAAN -->
                    <div class="grid grid-cols-2 gap-3">
                        <div class="border-2 border-black">
                             <div class="section-title">REFERENSI ANGGOTA (HARUS 2 ORANG)</div>
                             <div class="p-3 space-y-3">
                                <p class="text-xs italic">"Kami yang bertanda tangan di bawah ini menyatakan mengetahui dan mengenal dengan baik calon anggota KOSUDGAMA yang mengajukan permohonan ini. Apabila di kemudian hari calon anggota ini memiliki kewajiban yang harus diselesaikan dan atau dipenuhi kepada KOSUDGAMA, maka dalam hal tersebut kami ikut bertanggung jawab secara penuh."</p>
                                <div class="grid grid-cols-2 gap-4 mt-2">
                                    <div>
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="text-xs">Pemberi Referensi 1:</p>
                                            <div class="w-full h-12 mt-1 border-b border-dotted border-black"></div>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="input-group">
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="text-xs">Pemberi Referensi 2:</p>
                                            <div class="w-full h-12 mt-1 border-b border-dotted border-black"></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="border-2 border-black">
                            ...
                            <div class="p-3 h-full flex flex-col">
                                 <p class="text-xs italic flex-grow">"Dengan mengetahui, memahami dan menyetujui segala persyaratan yang diberikan, kami selaku calon anggota mengajukan permohonan untuk menjadi anggota KOSUDGAMA. Apabila di kemudian hari terdapat hambatan dalam pemenuhan kewajiban dari saya selaku anggota, maka dengan ini memberikan kuasa kepada KOSUDGAMA untuk mengambil segala tindakan yang diperlukan sesuai dengan peraturan yang berlaku."</p>
                                 <div class="text-center mt-auto">
                                     ...
                                     <div class="flex justify-center items-baseline">
                                        <span class="text-xs">( Nama & Tanda Tangan )</span>
                                        <button type="button" id="clear-signature" class="text-xs text-blue-600 hover:underline ml-4">Ulangi</button>
                                     </div>
                    ...
                    <!-- UPLOAD DOKUMEN -->
                    <div class="border-2 border-black">
                        <div class="section-title">UPLOAD DOKUMEN PENDUKUNG</div>
                        <div class="p-3 grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label for="pas_foto" class="form-label">Pas Foto 2x3 Berwarna</label>
                                <input type="file" id="pas_foto" name="pas_foto" class="form-input" required>
                            </div>
                            <div>
                                <label for="scan_ktp" class="form-label">Scan/Foto KTP</label>
                                <input type="file" id="scan_ktp" name="scan_ktp" class="form-input" required>
                            </div>
                            <div>
                                <label for="scan_sk" class="form-label">Scan/Foto SK Kepegawaian</label>
                                <input type="file" id="scan_sk" name="scan_sk" class="form-input" required>
                            </div>
                         </div>
                    </div>
                    ...
                    <div class="border-2 border-black">
                        <div class="section-title">UNTUK KEPERLUAN KOPERASI</div>
                        <div class="p-3 text-xs space-y-3">
                            <p>Catatan bagi Pengurus/Petugas:</p>
                            <div class="grid grid-cols-2 gap-x-8">
                                <div class="space-y-2">
                                    <p class="font-bold">Diperiksa & Disetujui</p>
                                    <div class="flex items-center gap-2">
                                        <label class="form-label w-24 shrink-0">Tanggal</label>
                                        <div class="flex-grow border-b border-dotted border-black h-4"></div>
                                    </div>
                                    <div class="flex items-start gap-2">
                                        <label class="form-label w-24 shrink-0">Nama & Tanda Tangan</label>
                                        <div class="flex-grow">
                                            <div class="w-full h-12"></div>
                                            <div class="border-t border-dotted border-black text-center">(...............................................)</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="space-y-2">
                            ...
                            <div class="flex items-center gap-2 pt-2">
                                ...
                                <div class="flex gap-1">
                                    <div class="w-6 h-6 border border-black bg-gray-100"></div>
                                    <div class="w-6 h-6 border border-black bg-gray-100"></div>
                                    <div class="w-6 h-6 border border-black bg-gray-100"></div>
                                    <div class="w-6 h-6 border border-black bg-gray-100"></div>
                                    <div class="w-6 h-6 border border-black bg-gray-100"></div>
                    ...
                    <div class="text-center pt-4">
                        <button type="submit" class="bg-blue-700 text-white font-bold py-2 px-8 rounded hover:bg-blue-800 transition duration-300 shadow-md">
                            KIRIM PENDAFTARAN
                        </button>
                    </div>
                </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function initCharBoxes(containerId, hiddenInputId) {
                ...
                // Fungsi untuk mengisi kotak dari hidden input (saat halaman load / ada error validasi)
                ...
                // Fungsi untuk mengupdate hidden input dari kotak
